module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c143 = "idhack:",
        peg$c144 = { type: "literal", value: "idhack:", description: "\"idhack:\"" },
        peg$c145 = "nupdated:",
        peg$c146 = { type: "literal", value: "nupdated:", description: "\"nupdated:\"" },
        peg$c147 = "upsert:",
        peg$c148 = { type: "literal", value: "upsert:", description: "\"upsert:\"" },
        peg$c149 = "locks(micros) w:",
        peg$c150 = { type: "literal", value: "locks(micros) w:", description: "\"locks(micros) w:\"" },
        peg$c151 = function(is_id_hack, updated_count, is_upsert, key_updates_count, write_lock_time) {
            return {
        ...
        peg$c152 = function(database, collection) {
            return {
              'database': database,
              'collection': collection
            };
          },
        peg$c153 = function(ts, context, message) {
            return {
        ...
        peg$c154 = "getmore",
        peg$c155 = { type: "literal", value: "getmore", description: "\"getmore\"" },
        peg$c156 = "query:",
        peg$c157 = { type: "literal", value: "query:", description: "\"query:\"" },
        peg$c158 = function(ts, context, ns, query, stats, duration) {
            return {
        ...
        peg$c159 = "query",
        peg$c160 = { type: "literal", value: "query", description: "\"query\"" },
        peg$c161 = function(ts, context, ns, query, stats, duration) {
            return {
        ...
        peg$c162 = "command",
        peg$c163 = { type: "literal", value: "command", description: "\"command\"" },
        peg$c164 = ".$cmd command:",
        peg$c165 = { type: "literal", value: ".$cmd command:", description: "\".$cmd command:\"" },
        peg$c166 = function(ts, context, database, spec, stats, duration) {
            return {
        ...
        peg$c167 = "update",
        peg$c168 = { type: "literal", value: "update", description: "\"update\"" },
        peg$c169 = "update:",
        peg$c170 = { type: "literal", value: "update:", description: "\"update:\"" },
        peg$c171 = function(ts, context, ns, spec, update, stats, duration) {
            return {
        ...
        peg$c172 = function(ts, severity, component, context, message) {
            return {
              'timestamp': ts.timestamp,
              'timestamp_format': ts.timestamp_format,
              'severity': severity,
        ...
        peg$c189 = function(members) { return members !== null ? members: {}; },
        peg$c190 = function(name, value) {
             return { name: name, value: value };
           },
        peg$c191 = function(v) { return v; },
        peg$c192 = function(first, rest) { return [first].concat(rest); },
        peg$c193 = function(values) { return values !== null ? values : []; },
        peg$c194 = { type: "other", description: "number" },
        peg$c195 = function() { return parseFloat(text()); },
        peg$c196 = { type: "other", description: "whitespace" },
        peg$c197 = /^[ \t\n\r]/,
        peg$c198 = { type: "class", value: "[ \\t\\n\\r]", description: "[ \\t\\n\\r]" },
        peg$c199 = /^[1-9]/,
        peg$c200 = { type: "class", value: "[1-9]", description: "[1-9]" },
        peg$c201 = /^[eE]/,
        peg$c202 = { type: "class", value: "[eE]", description: "[eE]" },
        peg$c203 = "0",
        peg$c204 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c205 = { type: "other", description: "json string" },
        peg$c206 = function(chars) { return chars.join(""); },
        peg$c207 = /^[a-zA-Z0-9$._]/,
        peg$c208 = { type: "class", value: "[a-zA-Z0-9$._]", description: "[a-zA-Z0-9$._]" },
        peg$c209 = function(chars) {return chars.join("");},
        ...
        peg$c236 = /^[ -!#-[\]-\u10FFFF]/,
        peg$c237 = { type: "class", value: "[ -!#-[\\]-\\u10FFFF]", description: "[ -!#-[\\]-\\u10FFFF]" },
        peg$c238 = /^[0-9]/,
                  ...
                  if (s7 !== peg$FAILED) {
                    ...
                    if (s8 !== peg$FAILED) {
                      ...
                      if (s9 !== peg$FAILED) {
                        ...
                        if (s10 !== peg$FAILED) {
                          peg$reportedPos = s0;
                          s1 = peg$c166(s1, s2, s5, s8, s9, s10);
                          s0 = s1;
                        } else {
                          peg$currPos = s0;
                          s0 = peg$c0;
                  ...
                  if (s7 !== peg$FAILED) {
                    ...
                    if (s8 !== peg$FAILED) {
                      ...
                      if (s9 !== peg$FAILED) {
                        ...
                        if (s10 !== peg$FAILED) {
                          peg$reportedPos = s0;
                          s1 = peg$c171(s1, s2, s4, s6, s8, s9, s10);
                          s0 = s1;
                        } else {
                          peg$currPos = s0;
                          s0 = peg$c0;
