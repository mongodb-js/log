module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c195 = "command admin.$cmd command: replSetHeartbeat",
        peg$c196 = { type: "literal", value: "command admin.$cmd command: replSetHeartbeat", description: "\"command admin.$cmd command: replSetHeartbeat\"" },
        peg$c197 = "numYields:",
        peg$c198 = { type: "literal", value: "numYields:", description: "\"numYields:\"" },
        peg$c199 = function(ts, context, spec, to_return_count, key_updates_count, yield_count, result_length, duration) {
            return {
        ...
        peg$c200 = { type: "other", description: "error events" },
        peg$c201 = /^[a-zA-Z0-9$._\/]/,
        peg$c202 = { type: "class", value: "[a-zA-Z0-9$._\\/]", description: "[a-zA-Z0-9$._\\/]" },
        peg$c203 = function(ts, severity, component, context, message) {
            return {
              'timestamp': ts.timestamp,
              'timestamp_format': ts.timestamp_format,
              'severity': severity,
        ...
        peg$c204 = { type: "other", description: "json value" },
        peg$c205 = function(value) { return value; },
        peg$c206 = "{",
        ...
        peg$c215 = function() { return null;  },
        peg$c216 = "true",
        peg$c217 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c218 = function() { return true;  },
        peg$c219 = { type: "other", description: "json object" },
        peg$c220 = function(m) { return m; },
        ...
        peg$c222 = function(members) { return members !== null ? members: {}; },
        peg$c223 = function(name, value) {
             return { name: name, value: value };
           },
        peg$c224 = { type: "other", description: "json array" },
        peg$c225 = function(v) { return v; },
        peg$c226 = function(first, rest) { return [first].concat(rest); },
        peg$c227 = function(values) { return values !== null ? values : []; },
        ...
        peg$c239 = { type: "other", description: "json string" },
        peg$c240 = function(chars) { return chars.join(""); },
        peg$c241 = /^[a-zA-Z0-9$._]/,
        peg$c242 = { type: "class", value: "[a-zA-Z0-9$._]", description: "[a-zA-Z0-9$._]" },
        peg$c243 = function(chars) {return chars.join("");},
        ...
        peg$c249 = "b",
        peg$c250 = { type: "literal", value: "b", description: "\"b\"" },
        peg$c251 = function() { return "\b"; },
        peg$c252 = "f",
        peg$c253 = { type: "literal", value: "f", description: "\"f\"" },
        peg$c254 = function() { return "\f"; },
        peg$c255 = "n",
        peg$c256 = { type: "literal", value: "n", description: "\"n\"" },
        peg$c257 = function() { return "\n"; },
        peg$c258 = "r",
        peg$c259 = { type: "literal", value: "r", description: "\"r\"" },
        peg$c260 = function() { return "\r"; },
        peg$c261 = "t",
        ...
        peg$c267 = function(sequence) { return sequence; },
        peg$c268 = /^[ -!#-[\]-\u10FFFF]/,
        peg$c269 = { type: "class", value: "[ -!#-[\\]-\\u10FFFF]", description: "[ -!#-[\\]-\\u10FFFF]" },
        peg$c270 = /^[0-9]/,
        peg$c271 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c272 = /^[0-9a-f]/i,
        peg$c273 = { type: "class", value: "[0-9a-f]i", description: "[0-9a-f]i" },
    ...
    function peg$parsereplset_heartbeat() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parsecontext();
        if (s2 !== peg$FAILED) {
          if (input.substr(peg$currPos, 44) === peg$c195) {
            s3 = peg$c195;
            peg$currPos += 44;
          } else {
            s3 = peg$FAILED;
                      ...
                      if (s9 !== peg$FAILED) {
                        ...
                        if (s10 !== peg$FAILED) {
                          ...
                          if (s11 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              s13 = input.substring(s12, peg$currPos);
                            }
                            s12 = s13;
                            if (s12 !== peg$FAILED) {
                              s13 = peg$parsews();
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    ...
                                    if (s17 !== peg$FAILED) {
                                      s17 = input.substring(s16, peg$currPos);
                                    }
                                    s16 = s17;
                                    if (s16 !== peg$FAILED) {
                                      s17 = peg$parsews();
                                      if (s17 !== peg$FAILED) {
                                        s18 = peg$parseduration();
                                        if (s18 !== peg$FAILED) {
                                          peg$reportedPos = s0;
                                          s1 = peg$c199(s1, s2, s4, s6, s9, s12, s16, s18);
                                          s0 = s1;
                                        } else {
                                          peg$currPos = s0;
                                          s0 = peg$c0;
