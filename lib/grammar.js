module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c138 = function(database, collection) {
            return {
              'database': database,
              'collection': collection
            };
          },
        peg$c139 = function(ts, context, message) {
            return {
        ...
        peg$c142 = "query:",
        peg$c143 = { type: "literal", value: "query:", description: "\"query:\"" },
        peg$c144 = function(ts, context, ns, query, stats, duration) {
              return {
                'timestamp': ts.timestamp,
                'timestamp_format': ts.timestamp_format,
                'thread': context.thread,
        ...
        peg$c145 = "command",
        peg$c146 = { type: "literal", value: "command", description: "\"command\"" },
        peg$c147 = ".$cmd command:",
        peg$c148 = { type: "literal", value: ".$cmd command:", description: "\".$cmd command:\"" },
        peg$c149 = function(ts, context, database, spec, stats, duration) {
            return {
        ...
        peg$c150 = function(ts, severity, component, context, message) {
            return {
              'timestamp': ts.timestamp,
              'timestamp_format': ts.timestamp_format,
              'severity': severity,
        ...
        peg$c170 = function(first, rest) { return [first].concat(rest); },
        peg$c171 = function(values) { return values !== null ? values : []; },
        peg$c172 = { type: "other", description: "number" },
        peg$c173 = function() { return parseFloat(text()); },
        ...
        peg$c181 = "0",
        peg$c182 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c183 = { type: "other", description: "json string" },
        peg$c184 = function(chars) { return chars.join(""); },
        peg$c185 = /^[a-zA-Z$._]/,
        peg$c186 = { type: "class", value: "[a-zA-Z$._]", description: "[a-zA-Z$._]" },
        ...
        peg$c195 = "b",
        peg$c196 = { type: "literal", value: "b", description: "\"b\"" },
        peg$c197 = function() { return "\b"; },
        peg$c198 = "f",
        peg$c199 = { type: "literal", value: "f", description: "\"f\"" },
        peg$c200 = function() { return "\f"; },
        peg$c201 = "n",
        peg$c202 = { type: "literal", value: "n", description: "\"n\"" },
        peg$c203 = function() { return "\n"; },
        peg$c204 = "r",
        peg$c205 = { type: "literal", value: "r", description: "\"r\"" },
        peg$c206 = function() { return "\r"; },
        peg$c207 = "t",
        peg$c208 = { type: "literal", value: "t", description: "\"t\"" },
        peg$c209 = function() { return "\t"; },
        peg$c210 = "u",
        peg$c211 = { type: "literal", value: "u", description: "\"u\"" },
        peg$c212 = function(digits) {
                  return String.fromCharCode(parseInt(digits, 16));
                },
        peg$c213 = function(sequence) { return sequence; },
        peg$c214 = /^[ -!#-[\]-\u10FFFF]/,
        peg$c215 = { type: "class", value: "[ -!#-[\\]-\\u10FFFF]", description: "[ -!#-[\\]-\\u10FFFF]" },
        peg$c216 = /^[0-9]/,
        peg$c217 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c218 = /^[0-9a-f]/i,
        peg$c219 = { type: "class", value: "[0-9a-f]i", description: "[0-9a-f]i" },
                      ...
                      if (s9 !== peg$FAILED) {
                        ...
                        if (s10 !== peg$FAILED) {
                          ...
                          if (s11 !== peg$FAILED) {
                            ...
                            if (s12 !== peg$FAILED) {
                              peg$reportedPos = s0;
                              s1 = peg$c144(s1, s3, s7, s10, s11, s12);
                              s0 = s1;
                            } else {
                              peg$currPos = s0;
                              s0 = peg$c0;
